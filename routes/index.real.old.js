...
router.post('/submit', function(req, res) {
  ...
  .done(function(err, users) {
    ...
    //console.log("The num of users is: " + User.count());
    User.count().success(function(num)
    {
      //console.log("The num of users is: " + num);
    ...
    //console.log(userId);
      ...
      .done(function(err, newTweet) {
        ...
        // var html = swig.renderFile(__dirname + '/../views/tweet.html', {
        //   tweet: newTweet,
